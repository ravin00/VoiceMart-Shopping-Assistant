# app/main.py  (voice-agent) - Pure Speech-to-Text Service
...
app = FastAPI(
    title="VoiceMart Speech-to-Text Service",
    version="1.0.0",
    description="Pure Speech-to-Text API for the VoiceMart Shopping Assistant"
)
...
async def root():
    return {
        "message": "VoiceMart Speech-to-Text Service",
        "docs": "/docs",
        "health": "/health",
